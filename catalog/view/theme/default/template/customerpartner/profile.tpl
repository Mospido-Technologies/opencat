      ...
      <div class="tab-content">
        ...
        <div id="tab-reviews" class="tab-pane">
          ...
          <?php if ($isLogged) { ?>
            <form class="form-horizontal">
              ...
              <div class="buttons">
                <div class="pull-right">
                  <button type="button" id="button-feedback" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary">
            ...
            <?php } else { ?>
            <a href="<?php echo $login; ?>" class="btn btn-primary" target="_blank">
              <?php echo $text_login; ?>
            </a>
            <?php } ?>
        </div> <!-- tab reviews -->
        <div id="tab-product-reviews" class="tab-pane"></div> <!-- product review tab -->
        <div id="tab-collection" class="tab-pane"></div> <!-- collection tab -->
        <div id="tab-location" class="tab-pane"></div> <!-- location tab -->
      </div> <!-- tab content -->
    </div> <!-- content -->
  </div> <!-- row -->
</div> <!-- container -->
...
$('#button-feedback').on('click', function() {
  $.ajax({
    ...
    data: {
      ...
      value_rating : encodeURIComponent($('input[name=\'value_rating\']:checked').val() ? $('input[name=\'value_rating\']:checked').val() : ''),
      quality_rating : encodeURIComponent($('input[name=\'quality_rating\']:checked').val() ? $('input[name=\'quality_rating\']:checked').val() : ''),
      price_rating : encodeURIComponent($('input[name=\'price_rating\']:checked').val() ? $('input[name=\'price_rating\']:checked').val() : ''),
    },
    beforeSend: function() {
