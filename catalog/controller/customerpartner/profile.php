...
class ControllerCustomerpartnerProfile extends Controller {
	...
	public function index() {
		...
		$data['feedback_total'] = $this->model_customerpartner_master->getTotalFeedback($this->request->get['id']);
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/customerpartner/profile.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/customerpartner/newprofile.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/customerpartner/newprofile.tpl', $data));
		}
	...
	public function feedback(){
		...
		$data['feedbacks'] = $this->model_customerpartner_master->getFeedbackList($this->request->get['id']);
